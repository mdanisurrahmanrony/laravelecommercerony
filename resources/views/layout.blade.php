                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> 01762930000</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> anisurrahmanrony3@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
 ...
 @yield('slider');
    ...
    <footer id="footer"><!--Footer-->
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-left">Copyright © 2019 DELTA E-SHOPPER Inc. All rights reserved.</p>
                    <p class="pull-right">Developped by <span><a target="_blank" href="http://sites.google.com/view/mdanisurrahmanrony/home">RONY</a></span></p>
                </div>
            </div>
        </div>
